...
$hesklang['ticket_assigned_to_you'] = '[#%%TRACK_ID%%] Ticket atribuído: %%SUBJECT%%';
...
$hesklang['new_note']               = '[#%%TRACK_ID%%] Nota adicionada à: %%SUBJECT%%';
$hesklang['new_pm']                 = 'Nova mensagem privada: %%SUBJECT%%';
$hesklang['forgot_ticket_id']       = 'Lista de seus tickets de suporte';
$hesklang['ticket_closed']			= '[#%%TRACK_ID%%] Ticket fechado/resolvido'; // New in 2.6.0
$hesklang['overdue_ticket']         = '[#%%TRACK_ID%%] Ticket atrasado'; // New in 3.2.0
$hesklang['ticket_escalated']       = '[#%%TRACK_ID%%] ESCALADO: %%SUBJECT%%'; // New in 3.2.0

// ERROR MESSAGES
$hesklang['cant_connect_db']='Não foi possível conectar ao banco de dados!';
$hesklang['invalid_action']='Ação inválida';
$hesklang['select_username']='Por favor selecione seu username';
$hesklang['enter_pass']='Por favor informe sua senha';
...
$hesklang['session_expired']='Sua sessão foi expirada. Use o formulário abaixo para logar novamente.';
$hesklang['attempt']='Tentativa inválida!';
$hesklang['not_authorized_tickets']='Você não está autorizado a visualizar tickets dentro desta categoria !';
...
$hesklang['no_trackID']='Sem identificação de rastreamento ';
$hesklang['status_not_valid']='Status inválido';
$hesklang['trackID_not_found']='ID de rastreamento não encontrado ';
$hesklang['select_priority']='Selecione a prioridade';
$hesklang['ticket_not_found']='Ticket não foi encontrado! Por favor informe o ID do ticket corretamente.';
$hesklang['no_selected']='Nenhum bilhete selecionado, nada para alterar';
$hesklang['id_not_valid']='Este não é um ID válido';
$hesklang['enter_id']='Por favor, insira o ID de rastreamento';
$hesklang['enter_name']='Por favor, insira o nome do cliente';
$hesklang['enter_date']='Por favor, insira a data que você deseja pesquisar';
$hesklang['date_not_valid']='Esta não é uma data válida. Por favor, insira a data em formato <b>DD-MM-YYYY</b>.';
$hesklang['enter_subject']='Por favor, insira o assunto do tíquete';
...
$hesklang['trackID']='ID do ticket';
$hesklang['timestamp']='Timestamp';
$hesklang['name']='Nome';
$hesklang['subject']='Setor';
...
$hesklang['date_posted']='Data criado';
...
$hesklang['find_ticket']='Buscar um ticket';
$hesklang['yyyy_mm_dd']='DD-MM-YYYY';
$hesklang['results_page']='rsultados por pagina';
...
$hesklang['ticket_trackID']='ID do ticket';
...
$hesklang['submit_ticket']='Enviar ticket';
...
$hesklang['view_your_ticket']='Ver seu ticket';
...
$hesklang['check4updates']='Verifique se há atualizações';
$hesklang['open']='Novo';
...
$hesklang['close_selected']='Marcar tickets selecionados como resolvidos';
...
$hesklang['settings']='Configuração';
...
$hesklang['forgot_tid']='Esqueceu o ID do ticket?';
...
$hesklang['sub_support']='Enviar ticket';
$hesklang['open_ticket']='Envie um novo problema para o setor de TI';
$hesklang['vet']='Ver tickets que você enviou no passado';
...
$hesklang['pinfo']='Informação de perfil';
...
$hesklang['assi']='Atribuído';
$hesklang['asst']='Atribuído para';
...
$hesklang['taso2']='Atribuído à outra staff';
$hesklang['nose']='Selecione o novo dono';
...
$hesklang['s_ot']='Atribuído à outros';
$hesklang['s_un']='Unassigned tickets';
$hesklang['s_for']='Procurar';
$hesklang['s_in']='Procurar em';
$hesklang['s_incl']='Search within';
$hesklang['find_ticket_by']='Buscar um ticket';
...
$hesklang['tid_mail']='<b>FUNÇÃO DESATIVADA</b>';
...
$hesklang['email_noreply']='&laquo;From:&raquo; email';
$hesklang['email_name']='&laquo;From:&raquo; name';
...
$hesklang['write_down']='<span style="color:red">Nós recomendamos que você escreva ou salve o ID do ticket para que você possa ver futuramente.</span>';
...
$hesklang['refresh_page']='Recarregar';
...
$hesklang['team']='Time';
$hesklang['banemail']='Banir Emails';
$hesklang['sm_title']='Mensagem de serviços';
$hesklang['et_title']='Templates de emails';
...
$hesklang['q_a']='Answer';
$hesklang['admin_login']='Bem-vindo! Por favor, logue-se.';
...
$hesklang['passs']='Redefinir senha';
...
$hesklang['back_to_login']='Voltar para logar';
...
$hesklang['new_team_member']='Novo usuário';
$hesklang['role']='Role';
...
$hesklang['thist']='Histórico de ticket';
$hesklang['type_your_message']='Digite sua mensagem';
$hesklang['close_button_text']='Fechar';
$hesklang['create_new_ticket']='Criar novo ticket';
$hesklang['ktool']='Knowledgebase tools';
$hesklang['delete_article']='Deletar artículo';
$hesklang['view_existing_tickets']='Ver tickets existentes';
$hesklang['view_existing']='Ver um ticket existente';
$hesklang['popart']='Top articles';
$hesklang['latart']='Latest articles';
$hesklang['sub_ticket']='Enviar Ticket';
$hesklang['how_can_we_help'] = 'Olá, como podemos ajudá-lo?';
$hesklang['search_for_articles'] = 'Search for articles';
$hesklang['submit_a_support_request'] = 'Envie uma solicitação de suporte';
$hesklang['maximum_x_attachments'] = 'Máximo de %s arquivos'; // %s = max number of attachments (specified in settings)
...
$hesklang['a_deselect']='Descelecionar tudo';
$hesklang['a_toggle']='Habilitar tudo';
$hesklang['ql_all']='Todos os tickets';
$hesklang['ql_alo']='Todos os tickets abertos';
$hesklang['ql_fit']='Tickets filstrados';
$hesklang['ql_a2m']='Atribuído a mim';
$hesklang['ql_a2o']='Atribuído a outros';
